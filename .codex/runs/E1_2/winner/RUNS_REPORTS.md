...
_Winner branch: main — 2025-09-13T10:21:10Z_

---

## Run A — PR #70 (5a87f1d)
_E1 pass-2: explorer source switcher hardening (health meta, defaults, tests package)_
...
- [x] No per-call locks or `as any` — code link: docs/claims-explorer.html
- [x] ESM internal imports include `.js` — code link: docs/claims-explorer.html
- [x] Tests parallel-safe, deterministic — test link: packages/explorer-test/test/claims-explorer.test.ts
- [x] Static mode issues no network calls — test link: packages/explorer-test/test/claims-explorer.test.ts
- [x] Source switch runtime-selectable — code/test link: docs/claims-explorer.html / packages/explorer-test/test/claims-explorer.test.ts
- [x] Default dataset/date on first load — code link: docs/claims-explorer.html
- [x] Tags panel hidden when dataset has no tags — code/test link: docs/claims-explorer.html / packages/explorer-test/test/claims-explorer.test.ts

## EXTRA BLOCKERS (pass-2)
- [x] Tags only from `/health` or static meta — code link: docs/claims-explorer.html
- [x] No network in static-mode tests — test link: packages/explorer-test/test/claims-explorer.test.ts
- [x] DOM tests isolated in `packages/explorer-test/` — test link: packages/explorer-test/test/claims-explorer.test.ts

## Acceptance (oracle)
- [x] Source toggle preserves state
- [x] Offline static mode renders; API failure handled
- [x] Defaults visible on first load
- [x] Tags panel present only with tags
- [x] Cross-source deterministic render
- [x] Build/packaging correctness (ESM)
- [x] Code quality

## Evidence
- Code: docs/claims-explorer.html
- Tests: packages/explorer-test/test/claims-explorer.test.ts
- Runs: `pnpm test`
...
## EXTRA BLOCKERS (pass-2)
- [x] Tags sourced only from health/static meta — code link: docs/claims-explorer.html
- [x] No network in static-mode tests — test link: packages/explorer-test/claims-explorer.test.ts
- [x] DOM tests isolated under `packages/explorer-test/` — test link: packages/explorer-test/claims-explorer.test.ts

## Acceptance (oracle)
- [x] Source toggle preserves state
- [x] Offline static mode renders
- [x] Defaults visible on first load
- [x] Tags panel present only with tags
- [x] Deterministic output across repeats
- [ ] Cross-runtime parity (n/a)
- [x] Build/packaging correctness (ESM)
- [x] Code quality
...
## End Goal fulfillment
- EG-1: Explorer switches between static and API sources at runtime while preserving state【F:docs/claims-explorer.html†L226-L282】【F:packages/explorer-test/claims-explorer.test.js†L74-L91】
- EG-2: Defaults derive from `at` or `generated_at`; tags render only when provided in meta【F:docs/claims-explorer.html†L258-L266】【F:packages/explorer-test/claims-explorer.test.js†L59-L66】
- EG-3: Cross-source renders are byte-identical given the same data【F:packages/explorer-test/claims-explorer.test.js†L68-L91】

## Blockers honored
- B-1: ✅ Static mode makes no network requests【F:packages/explorer-test/claims-explorer.test.js†L61-L66】
- B-2: ✅ Tags sourced from health/static meta only【F:docs/claims-explorer.html†L128-L142】【F:packages/explorer-test/claims-explorer.test.js†L93-L108】
- B-3: ✅ API failure handled without crash【F:docs/claims-explorer.html†L189-L207】【F:packages/explorer-test/claims-explorer.test.js†L110-L118】

## Lessons / tradeoffs (≤5 bullets)
- Centralizing meta via `/health` simplifies tag/date handling.
- Separate test package prevents jsdom dep leakage across workspace.
- Polling ensures DOM settles for deterministic snapshots.
...
- [x] No per-call locks or `as any` — code link: docs/claims-explorer.html
- [x] ESM internal imports include `.js` — code link: docs/claims-explorer.html
- [x] Tests parallel-safe, deterministic — test link: packages/explorer-test/claims-explorer.test.js
- [x] Static mode issues no network calls — test link: packages/explorer-test/claims-explorer.test.js
- [x] Source switch runtime-selectable — code/test link: docs/claims-explorer.html / packages/explorer-test/claims-explorer.test.js
- [x] Default dataset/date on first load — code link: docs/claims-explorer.html
- [x] Tags panel hidden when dataset has no tags — code/test link: docs/claims-explorer.html / packages/explorer-test/claims-explorer.test.js

## EXTRA BLOCKERS (pass-2)
- [x] Tags sourced only from health/static meta — code link: docs/claims-explorer.html
- [x] DOM tests isolated in `packages/explorer-test` — test link: packages/explorer-test/claims-explorer.test.js
- [x] No network in static-mode tests — test link: packages/explorer-test/claims-explorer.test.js
- [x] Cross-source determinism — test link: packages/explorer-test/claims-explorer.test.js
...
- [x] Defaults visible on first load
- [x] Tags panel present only with tags
- [x] Deterministic output across sources
- [ ] Cross-runtime parity (n/a)
- [x] Build/packaging correctness (ESM)
- [x] Code quality
...
## Evidence
- Code: docs/claims-explorer.html
- Tests: packages/explorer-test/claims-explorer.test.js
- Runs: `pnpm test`
...
- [x] No per-call locks or `as any` — code link: docs/claims-explorer.html
- [x] ESM internal imports include `.js` — code link: docs/claims-explorer.html
- [x] Tests parallel-safe, deterministic — test link: docs/claims-explorer.test.ts
- [x] Static mode issues no network calls — test link: docs/claims-explorer.test.ts
- [x] Source switch runtime-selectable — code/test link: docs/claims-explorer.html / docs/claims-explorer.test.ts
- [x] Default dataset/date on first load — code link: docs/claims-explorer.html
- [x] Tags panel hidden when dataset has no tags — code/test link: docs/claims-explorer.html / docs/claims-explorer.test.ts
...
## Evidence
- Code: docs/claims-explorer.html
- Tests: docs/claims-explorer.test.ts
- Runs: `pnpm test`
...
- Strategy: fetch meta from `/health`, sort tags, default date from generated_at, and isolate DOM tests in a workspace package.
- Key changes: docs/claims-explorer.html; packages/explorer-test/claims-explorer.test.js; package.json; pnpm-lock.yaml; CHANGES.md; COMPLIANCE.md; REPORT.md.
- Determinism runs: `pnpm test` — static vs API renders identical.
- Tradeoffs: moving tests to their own package keeps jsdom scoped but requires additional workspace wiring.
