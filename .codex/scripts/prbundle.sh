#!/usr/bin/env bash
# Relocated from scripts/prbundle.sh (canonical path under .codex/scripts)
set -euo pipefail
...
Examples:
  ./.codex/scripts/prbundle.sh 19-22
  ./.codex/scripts/prbundle.sh -r LexLattice/tf-lang 19 20 21 22
  OUT=docs/pr/custom.md ./.codex/scripts/prbundle.sh 30-35
