...
## 2025-09-16T23:45:00Z
- Review fix: hardened canonical helpers to reject non-JSON inputs, added pretty canonical JSON, and expanded TS/Rust tests plus utils alias for workspace resolution.
