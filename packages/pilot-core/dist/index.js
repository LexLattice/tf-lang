...
export function canonNumber(value) {
...
export function toMinorUnits(value, scale) {
...
export function canonFrame(input) {
    ...
    for (const key of ['bid', 'ask', 'last', 'vol']) {
...
export const validators = {
    frame: (value) => FrameSchema.parse(value),
    order: (value) => OrderSchema.parse(value),
    state: (value) => StateSchema.parse(value)
};
