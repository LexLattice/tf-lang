...
`;
  ...
  assert.ok(Array.isArray(badSummary.issues) && badSummary.issues.length >= 1);
  assert.equal(badSummary.issues[0].line, 1);
  assert.equal(badSummary.issues[0].issue, 'schema');
});
